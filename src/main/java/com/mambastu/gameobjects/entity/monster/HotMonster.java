...
public class HotMonster extends BaseMonster {
    ...
    public HotMonster() {
        super();
        this.bornImage = ImageManager.getInstance().getImg("bornImage", "Monster", "HotMonster");
        this.omenImage = ImageManager.getInstance().getImg("omenImage", "Monster", "HotMonster");
        this.dieImage = ImageManager.getInstance().getImg("dieImage", "Monster", "HotMonster");
        setImageSize(50, 50);
        this.damage = 10;
