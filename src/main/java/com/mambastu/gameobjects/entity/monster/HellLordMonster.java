...
public class HellLordMonster extends BaseMonster {
    ...
    public HellLordMonster() {
        ...
        this.omenImage = ImageManager.getInstance().getImg("omenImage", "Monster", "HellLord");
        this.bornImage = ImageManager.getInstance().getImg("bornImage", "Monster", "HellLord");
        this.dieImage = ImageManager.getInstance().getImg("dieImage", "Monster", "HellLord");
        this.warnImage = ImageManager.getInstance().getImg("warnImage", "Monster", "HellLord");
        this.dashImage = ImageManager.getInstance().getImg("dashImage", "Monster", "HellLord");
        this.redEyeImage = ImageManager.getInstance().getImg("redEyeImage", "Monster", "HellLord");
        this.curtainImage = ImageManager.getInstance().getImg("curtainImage", "Monster", "HellLord");
