...
//
//        @Override
//        public boolean isColliding(Bounds aim) {
//
...
//                double closestX = clamp(aimCircle.getCenterX().get(), x.get(), x.get() + width);
//                double closestY = clamp(aimCircle.getCenterY().get(), y.get(), y.get() + height);
//                double dx = aimCircle.getCenterX().get() - closestX;
//                double dy = aimCircle.getCenterY().get() - closestY;
//                return dx * dx + dy * dy < aimCircle.getRadius() * aimCircle.getRadius();
//            }
//            return false;
//        }
//
...
//        protected double prevY;
        ...
        public CircleBounds(SimpleDoubleProperty x, SimpleDoubleProperty y, double radius) {
...
//                        prevY < imageY && isImageViewCenterNearLine(centerX.get(),centerY.get(),radius,wallX, wallY, wallX + width, wallY);
//                boolean intersectsBottom =
//                        prevY > imageY && isImageViewCenterNearLine(centerX.get(),centerY.get(), radius,wallX, wallY + height, wallX + width, wallY + height);
//                boolean intersectsLeft =
//                        prevX < imageX && isImageViewCenterNearLine(centerX.get(),centerY.get(),radius, wallX, wallY, wallX, wallY + height);
//                boolean intersectsRight =
//                        prevX > imageX && isImageViewCenterNearLine(centerX.get(),centerY.get(), radius,wallX + width, wallY, wallX + width, wallY + height);
//                if ((intersectsBottom || intersectsTop)) imageY = oldY;
//                if ((intersectsLeft || intersectsRight)) imageX = oldX;
//                return  (intersectsBottom || intersectsTop||intersectsLeft || intersectsRight);
//            }
            return false;
        }
